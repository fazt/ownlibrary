...
async def run_test():
    ...
    try:
        ...
        # -> Type 'no.existe@example.com' into the email field (index 76), then type password, submit, wait and search for the error text 'credenciales'.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div/div/div/div/form/div/div/input').nth(0)
        await asyncio.sleep(3); await elem.fill('no.existe@example.com')
